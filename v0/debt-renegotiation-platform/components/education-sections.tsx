...
const column3 = [
    ...
    },
    {
        title: "Método VITAL",
        content:
            "O Método VITAL organiza suas necessidades em níveis prioritários: Sobrevivência (básico), Segurança (reserva) e Negociação (dívidas). Garanta cada nível antes de avançar para o próximo — assim você constrói uma base financeira sólida e sustentável.",
    },
];
...
const EducationSections = () => (
    <section id="educacao" className="w-full py-16 relative overflow-hidden bg-slate-50 dark:bg-card/50">
        <div
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
            <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground mt-2">
                    Conceitos fundamentais para sua liberdade financeira
                </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 className="font-bold text-experian-purple mb-4 text-lg border-b pb-2 border-experian-purple/20">Investimentos</h3>
                    <FaqColumn items={column1} />
                </div>
                <div>
                    <h3 className="font-bold text-experian-dark-blue mb-4 text-lg border-b pb-2 border-experian-dark-blue/20">Conceitos</h3>
                    <FaqColumn items={column2} />
                </div>
                <div>
                    <h3 className="font-bold text-experian-green mb-4 text-lg border-b pb-2 border-experian-green/20">Proteção</h3>
