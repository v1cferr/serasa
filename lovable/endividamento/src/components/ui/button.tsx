  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // CTA variants - Editorial style
        cta: "bg-accent text-accent-foreground font-semibold tracking-wide hover:bg-accent/90 hover:shadow-[4px_4px_0_0_hsl(var(--foreground))] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all",
        "cta-outline": 
          "border-2 border-primary-foreground text-primary-foreground bg-transparent hover:bg-primary-foreground hover:text-primary font-medium tracking-wide",
        soft: "bg-accent/15 text-accent hover:bg-accent/25 font-medium",
      },
      size: {
